...
slug: "where-it-is-going"
order: 7
section: "Project"
template: doc
status: published
nav: sidebar
excerpt: "The direction of the project and the ecosystem it sits in — what is built, and what is intended."
generated: "docs-composed"
---

# Where it is going

The direction of the project and the ecosystem it sits in — what is built, and what is intended.
...
Logician and AI researcher. Co-author of the RDF Semantics specification. His work on formal semantics gave RDF its rigorous logical foundation.

### RDF 1.0 Specification

First W3C Recommendation for the Resource Description Framework. Established the triple model (subject-predicate-object) and RDF/XML serialization. The formal birth of machine-readable knowledge graphs on the web.
...
Tim Berners-Lee, James Hendler, and Ora Lassila published 'The Semantic Web' in Scientific American, describing a future web where machines understand meaning — not just display pages. This article launched a global research movement.
