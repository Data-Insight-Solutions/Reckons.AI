...
w.end((err, result: string) => {
  if (err) throw err;
  writeFileSync(TO, `# Shipped work, split out of the roadmap so it stays queryable without cluttering the plan.\n# Generated by scripts/agent/split.ts — regenerate rather than hand-edit.\n\n` + result);
});
